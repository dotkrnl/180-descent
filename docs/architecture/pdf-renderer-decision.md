...
- `src/content/days/###-slug/` is the canonical route path; `day.yaml` remains the canonical manifest for day number, block, localized metadata, appendices, interaction scripts, and assets.
