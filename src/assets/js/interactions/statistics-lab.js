    ...
    function paint(rate,nTests){
      ...
      if (nTests === 1) {
        read.innerHTML = isZh
          ...
          : 'No tricks enabled. If the null is true and the assumptions hold, <span class="fp-tests">1 pre-specified test</span> per study gives the error rate the system promises.';
        return;
      }
      var label = p100 < 15
