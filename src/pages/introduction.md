...
The first six days set the tone. Day 1 asks why a stopped clock can give you a true, justified belief without giving you knowledge; Day 2 scales that worry up to science as an institution; Day 3 opens the reasoning engine itself; Day 4 turns uncertainty into a calculus with Monty Hall, Bayes' theorem, and e-values{% tip 'An e-value is statistical evidence represented as the payoff from a fair bet against a null hypothesis.' %}; Day 5 draws the harder line between seeing a pattern and naming a cause; and Day 6 shows how p-hacking, confidence intervals, effect sizes, and multiverse analysis keep statistical inference from fooling itself.
