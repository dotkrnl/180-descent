...
<Hero>
<HeroEyebrow>Block I · Foundations of Knowledge &amp; Reasoning · <span class="daymark">Day 02 / 180</span></HeroEyebrow>
...
<PanelTitle>Interactive · run the searchlight</PanelTitle>

### The Demarcation Lab

<PanelNote>Pick a claim. We'll run it past **Popper** (is it falsifiable?) — and then past **Kuhn**, **Lakatos**, and the **cluster view**, all of which complicate his verdict. Notice how often the four lenses disagree. That disagreement *is* the philosophy of science.</PanelNote>
...
<div class="oscrow">
<div class="lab"><b>47%</b> of original effects landed inside the replication's <em class="term">95% confidence interval</em><TipNote text={"A 95% confidence interval is the range a method would capture the true value in 95% of repeated uses, not a direct 95% probability that this particular interval contains it."} /></div>
...
<div class="oscrow">
<div class="lab"><b>≈50%</b> — replication <em class="term">effect sizes</em><TipNote text={"An effect size is a standardized measure of how large a reported effect is, apart from whether it merely clears a significance threshold."} /> were, on average, about <em>half</em> the original magnitude</div>
<div class="bartrack"><div class="barfill rep" data-w="50"></div></div>
<div class="pct">~50%</div>
</div>
</div>
<p style="font-size:.92em;color:var(--ink-soft);margin-top:1rem;">Whenever you see "only a third of psychology is real," someone has grabbed the <em>36%</em> and dropped the rest. The honest summary is subtler and more interesting: replication effects were <strong>weaker on average</strong> — roughly half as strong as first reported, and often too weak for an <em class="term">underpowered</em><TipNote text={"An underpowered study has too little data, or too much noise, to reliably detect an effect of the relevant size."} /> repeat to catch. <span style="color:var(--accent-deep);font-weight:500;">[ESTABLISHED]</span> for the numbers themselves; <span style="color:var(--hint);font-weight:500;">[CONTESTED]</span> for how far they license claims about which original effects were real.</p>
