...
<PanelTitle>Interactive · pick your escape</PanelTitle>

### The Skeptic's Syllogism — four doors out

<PanelNote>The argument below is valid: if you accept all three lines, you're a skeptic. So you must reject something. Each rejection is a real move with real defenders — and real costs. Pick one and see whose company you've joined.</PanelNote>
...
<Panel class="web-only stakes-dial">
<PanelTitle>Interactive · same evidence, shifting verdict</PanelTitle>

### The Bank Cases — the Stakes Dial

<PanelNote>Your evidence is fixed: *"I was at this bank two Saturdays ago, and it was open."* Nothing about the world or your eyesight changes. Slide the stakes; optionally let your spouse raise the possibility of error. Watch "I know" turn into "I'd better check" — and read how three rival camps explain the very same flip.</PanelNote>
...
<Panel class="web-only modal-rings">
<PanelTitle>Diagram · the neighborhood of a belief</PanelTitle>

### Safe vs. Lucky — a modal X-ray

<PanelNote>Center dot = the actual world, where your belief is true. Ring = nearby possible worlds, the realistic near-misses. <span class="tone-ok">Green</span> = you'd still be right there; <span class="tone-contested">red</span> = you'd believe it and be wrong. Knowledge needs a green neighborhood.</PanelNote>
