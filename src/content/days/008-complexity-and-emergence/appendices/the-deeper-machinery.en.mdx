...
Now the part that made physicists fall out of their chairs in the 1970s. Some phase boundaries terminate at a *critical point* — a precise temperature and pressure where the distinction between two phases is about to vanish — and the system fluctuates at every scale at once: tiny droplets inside bigger droplets inside bigger ones, with no characteristic size. Fluids do it; magnets do something analogous as they lose their magnetism at the Curie temperature; even some models of neural tissue borrow the same language. And here is the shock: systems in the same universality class can share critical exponents and scaling functions after suitable rescaling. A boiling fluid and a demagnetizing lump of iron are not literally the same, and their nonuniversal amplitudes still differ, but near criticality their large-scale behavior can follow the same mathematical pattern.
...
> Order arises for free. Even randomly assembled networks can fall spontaneously into stable, repeating patterns — without any tuning, design, or selection at all. Stuart Kauffman, on random Boolean networks (1969; At Home in the Universe, 1995)
...
**The deepest, most rigorous emergence we have is the phase transition** — whose mathematically sharp form is a collective, thermodynamic-limit phenomenon, with the miracle of universality showing that high-level laws can be genuinely autonomous from many microscopic details (which is precisely *why* "is this new, or just the parts re-described?" is a real and hard question, not a cheap shot).
