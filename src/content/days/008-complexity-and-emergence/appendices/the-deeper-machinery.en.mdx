...
The phase transition in §1 is profound but abstract. <Term as="em">Percolation</Term><TipNote text={"Percolation studies when local connected pieces suddenly form a system-spanning cluster."} /> is its baby cousin, and it's so simple you can hold it in your hand. Picture a grid. Independently, with probability *p*, fill each cell (a tree in a forest; a conducting grain in a film; an open pore in a rock). Now ask one question: **does a connected cluster of filled cells span the whole grid, edge to edge?**
...
This box summarizes the main result shown by the web interaction.
</Aside>
